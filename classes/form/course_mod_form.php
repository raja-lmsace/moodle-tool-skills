...
/**
 * Tool skills - Course module form.
 *
 * @package   tool_skills
...
class course_mod_form extends \core_form\dynamic_form {
    ...
    public function definition() {
        ...
        $mform->hideIf('level', 'uponmodcompletion', 'in', [skills::COMPLETIONNOTHING, skills::COMPLETIONPOINTS, skills::COMPLETIONPOINTSGRADE]);
    ...
    public function set_data_for_dynamic_submission(): void {
        ...
        if ($skillid && $courseid) {
            $record = (array) $DB->get_record('tool_skills_course_activity', ['skill' => $skillid, 'courseid' => $courseid, 'modid' => $modid]);
            $defaults += $record;
        }
    ...
    protected function get_page_url_for_dynamic_submission(): moodle_url {
        return new moodle_url('/admin/tool/skills/manage/modlist.php',
            ['courseid' => $this->optional_param('courseid', 0, PARAM_INT), 'modid' => $this->optional_param('modid', 0, PARAM_INT)]);
    }
