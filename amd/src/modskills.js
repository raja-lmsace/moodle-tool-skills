define(['jquery', 'core/modal_factory', 'core/str', 'core_form/modalform'], function($, ModalFactory, Str, ModalForm) {
    ...
    const SELECTORS = {
        table: '#tool_mod_skills_list',
        editskill: '[data-target="toolskill-edit"]',
        skillsRow: '#tool_mod_skills_list .skill-actions a.action-edit'
    };
    ...
    class ToolSkillsCourses {
        ...
        constructor(skillID, courseID, modID) {
            ...
            this.SELECTORS.root = '#tool_mod_skills_list [data-skillid="' + this.skillID + '"]';
        ...
        showContentForm() {
            ...
            var formClass = 'tool_skills\\form\\course_mod_form';
            ...
            const modalForm = new ModalForm({
                ...
                modalConfig: {title: Str.get_string('moduleskills', 'tool_skills')},
            });
